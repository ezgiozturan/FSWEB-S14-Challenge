...
public class Main {
    public static void main(String[] args) {
        ...
        HealthyBurger healthyBurger = new HealthyBurger("Vegan Burger", 5.67, "Tofu" ,"Sandwich");
        ...
        DeluxeBurger db = new DeluxeBurger("Deluxe Burger", "Double", 19.1 , "Double Sandwich");
